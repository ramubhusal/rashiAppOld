...
var Searchbar = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var _f7Searchbar = (0, _react.useRef)(null);
  ...
  var onMount = function onMount() {
    ...
    (0, _f.f7ready)(function () {
      ...
      _f7Searchbar.current = _f.f7.searchbar.create(params);
    });
  };
  ...
  return /*#__PURE__*/_react.default.createElement(SearchbarTag, _extends({
    ref: elRef,
    id: id,
    style: style,
    className: classes
