...
var Messages = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var _f7Messages = (0, _react.useRef)(null);
  ...
  var onMount = function onMount() {
    ...
    (0, _f.f7ready)(function () {
      _f7Messages.current = _f.f7.messages.create((0, _utils.noUndefinedProps)({
        el: elRef.current,
  ...
  (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(function () {
    ...
    if (_f7Messages.current) {
      ...
      if (childrenBeforeUpdated.current !== childrenAfterUpdated && _f7Messages.current.scroll && scrollMessages) {
        _f7Messages.current.scroll();
      }
    }
