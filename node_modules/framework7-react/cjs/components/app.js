...
var App = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var classes = (0, _utils.classNames)(className, 'framework7-root', (0, _mixins.colorClasses)(props)); // eslint-disable-next-line

  if (!_f.f7 || typeof window === 'undefined') {
    (0, _f.f7init)(elRef.current, params, false);
  }
  ...
  (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(function () {
    ...
    if (_f.f7) {
      _f.f7.init(elRef.current);

      return;
    }

    (0, _f.f7init)(elRef.current, params, true);
  }, []);
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    className: classes,
    ref: elRef
  }, extraAttrs), children, /*#__PURE__*/_react.default.createElement(_routableModals.default, null));
});
