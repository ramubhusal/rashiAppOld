...
var View = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var _f7View = (0, _react.useRef)(null);
  ...
  if (_f.f7 && !_f7View.current && init) {
    var routerId = (0, _utils.getRouterId)();
    _f7View.current = _f.f7.views.create(elRef.current, _extends({
      routerId: routerId,
      init: false
    ...
    _f.f7routers.views.push(routerData.current);

    if (_f7View.current && _f7View.current.router && (url || main)) {
      var initialData = (0, _getRouterInitialComponent.getRouterInitialComponent)(_f7View.current.router, initialPageComponent);
  ...
  var onMount = function onMount() {
    (0, _f.f7ready)(function () {
      if (_f7View.current) {
        ...
        routerData.current.instance = _f.f7.views.create(elRef.current, _extends({
          routerId: _routerId
        }, (0, _utils.noUndefinedProps)(props), {
          browserHistoryInitialMatch: browserHistoryInitialMatch,
          on: {
  ...
  var onDestroy = function onDestroy() {
    ...
    _f.f7routers.views.splice(_f.f7routers.views.indexOf(routerData.current), 1);
  ...
  (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(function () {
    if (routerData.current && _f.f7) {
      _f.f7events.emit('viewRouterDidUpdate', routerData.current);
    }
  });
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    ...
    }, initialComponent ? /*#__PURE__*/_react.default.cloneElement(initialComponent, _extends({}, pageProps)) : isAsync ? (0, _useAsyncComponent.useAsyncComponent)(PageComponent, pageProps) : /*#__PURE__*/_react.default.createElement(PageComponent, pageProps));
  }));
});
