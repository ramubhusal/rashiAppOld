...
var Tab = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  if (_f.f7 && !routerData.current) {
    routerData.current = {
      setTabContent: setTabContent
    };

    _f.f7routers.tabs.push(routerData.current);
  }
  ...
  var onDestroy = function onDestroy() {
    ...
    _f.f7routers.tabs.splice(_f.f7routers.tabs.indexOf(routerData.current), 1);
  ...
  (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(function () {
    ...
    _f.f7events.emit('tabRouterDidUpdate', routerData.current);
  });
  ...
  var renderChildren = function renderChildren() {
    ...
    return /*#__PURE__*/_react.default.createElement(TabContent, _extends({
      key: tabContent.id
    }, tabContent.props));
  };
